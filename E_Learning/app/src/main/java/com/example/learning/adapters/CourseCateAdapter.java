...
public class CourseCateAdapter extends CommonAdapter {
    public CourseCateAdapter(Context context, ArrayList datas, int layoutId) {
    ...
    public void setView(ViewHolder holder, Object o, int position) {
        ...
        CourseCateBean bean = (CourseCateBean) o;

        TextView tv_name = holder.getView(R.id.tv_course_name);
        tv_name.setText(bean.getTitle() + "(" + bean.getList().size() + ")");
    }
}
